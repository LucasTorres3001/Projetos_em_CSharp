...
namespace Std{
    ...
    class Usuarios{
        ...
        string NomeDoUsuario,SobrenomeDoUsuario,MesDoNasc,CidadeNatal,UF,Nacionalidade,EtniaDoUsuario,SexoDoUsuario;
        short DiaDoNasc;
        int AnoDeNasc,IdadeDoUsuario;
        double Massa,Altura,imc;

        public Cheetos(int a, string Nome, string Sobrenome, string Mes, string LocalDeNasc, string Estado, string Nacao, string Etnia, string Sexo, short Dia, int Ano, int Idade, double M, double H, double IMC){
            if(a < 1 || a > 2){
        ...
        public void Info(){
            ...
            Console.WriteLine("Nome_________________ {0} {1}\n",NomeDoUsuario,SobrenomeDoUsuario);
    ...
    class Home{
        ...
        public static void Main(string[] args){
            ...
            string Name,Surname,CityOfBirth,StatesOfBirth,Nationality,Ethnicity,SexOfUser;
            short DayOfBirth;
            int YearOfBirth;
            byte NumberOfMonth;
            ...
            Console.Write("\nDigite o sobrenome do usuário(a): ");
            ...
            string Name2,Surname2,CityOfBirth2,StateOfBirth2,Nationality2,Ethnicity2,SexOfUser2;
            short DayOfBirth2;
            int YearOfBirth2;
            byte NumberOfMonth2;
            ...
            do{
                ...
                if(DayOfBirth2 < 0 || DayOfBirth2 > 31){
                    Console.WriteLine("\n    [ERROR] Day not valid! :( ...\n\n");
                }
            }
            while(DayOfBirth2 < 0 || DayOfBirth2 > 31);
            do{
                Console.Write("\nDigite o número do mês de nascimento: ");
            ...
            Usuarios Individuo = new Usuarios(1,Name,Surname,MonthOfYear[NumberOfMonth-1],CityOfBirth,StatesOfBirth,Nationality,Ethnicity,SexOfUser,DayOfBirth,YearOfBirth,(DateTime.Now.Year-YearOfBirth),Weight,Height,(Weight/(Height*Height)));

            Usuarios Individuo2 = new Usuarios(2,Name2,Surname2,MonthOfYear2[NumberOfMonth2-1],CityOfBirth2,StateOfBirth2,Nationality2,Ethnicity2,SexOfUser2,DayOfBirth2,YearOfBirth2,(DateTime.Now.Year-YearOfBirth2),Weight2,Height2,(Weight2/(Height2*Height2)));
